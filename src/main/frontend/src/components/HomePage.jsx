    ...
    return (
      <div className="App">
        ...
        <Container>
          <Row>
            <Col id="col1">
              1 of 3 There are many variations of passages of Lorem Ipsum
              ...
              dictionary of over 200 Latin words, combined with There are many
              ...
              words, combined with There are many variations of passages of
              ...
              It uses a dictionary of over 200 Latin words, combined with There
            ...
            <Col id="col3">
              3 of 3 a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum is that it has a more-or-less normal
              distribution of letters, as opposed to using 'Content here,
              content here', making it look like readable English. Many desktop
              publishing packages and web page editors now use Lorem Ipsum as
              their default model text, a long established fact that a reader
